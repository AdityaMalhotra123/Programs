...
public class HashDiff extends Diff {
	 ...
	 * hash table to store previously-calculated diffs  */
	 protected Hashtable<IntPair, Association<Integer, String>> store;
	/**
	...
	*/
	public HashDiff(String file1Name, String file2Name) {
		...
		store = new Hashtable<IntPair, Association<Integer, String>>();
	}
	...
	*/
	public Association<Integer, String> returner(Hashtable<IntPair, Association<Integer, String>> store,
	IntPair recorded, Association<Integer, String> match, Association<Integer, String> removef1,
	...
	public Association<Integer, String> diffHelper(int remainingFile1Index, int
		...
		IntPair recorded = new IntPair(remainingFile1Index, remainingFile2Index);
